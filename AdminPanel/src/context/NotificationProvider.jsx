...
export default function NotificationProvider({children}) {
    ...
    useEffect(() => {
        ...
        ref?.classList.remove('bottom-14', 'opacity-0');
        ref?.classList.add('bottom-10', 'opacity-1');
        return () => {
            ref?.classList.add('bottom-14', 'opacity-0');
            ref?.classList.remove('bottom-10', 'opacity-1');
        }
    }, [notification.value])
    ...
    return (
        <>
            ...
            { notification.value ? (
                <p ref={notificationRef} className={ backgroundColor + 
